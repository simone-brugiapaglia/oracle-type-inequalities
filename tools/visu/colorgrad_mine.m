...
function c = colorgrad_mine(varargin)

n = 16;
t = 'blue_down';


violet = [0.48 0.41 0.93] ;
mediumBlue = [0 0 0.8] ;
deepBlueSky = [0 0.75 1] ;
...
colourFull = cat(1,violet, mediumBlue,deepBlueSky,Aquamarine,yellow,hotPink,coral,red,kaki,black) ;
